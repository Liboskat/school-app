    ...
    <jsp:attribute name="navigation">
        ...
        <c:choose>
            <c:when test="${category eq 'timetable'}">
                ...
                <a class="navigation_button" href=<c:url value="/account?category=homework"/>>
                    <div class="inside_button_text">
                        Домашнее задание
                    </div>
                </a>
                ...
                <a class="navigation_button" href=<c:url value="/account?category=statistics"/>>
                    <div class="inside_button_text">
                        Средние оценки
                    </div>
                </a>
            ...
            <c:when test="${category eq 'homework'}">
            ...
            <c:when test="${category eq 'statistics'}">
                <a class="navigation_button" href=<c:url value="/account?category=timetable"/>>
                    <div class="inside_button_text">
                        Расписание
                    </div>
